...
class Cell:
    ...
    def __add__(self, other_cell):
        return self.number_cells + other_cell.number_cells

    def __sub__(self, other_cell):
        if self.number_cells > other_cell.number_cells:
            return self.number_cells - other_cell.number_cells
        else:
            print('новая клетка не может иметь количество ячеек меньше нуля')
    ...
    def make_order(self, row):
        print('\n'.join(wrap('*' * self.number_cells, width=row)))
